...
public class TaskController {
    ...
    public ResponseEntity<MultipleChoiceTask> newMultipleChoice(@Valid @RequestBody NewMultipleChoiceTaskDTO dto) {
        MultipleChoiceTask task = taskService.createMultipleChoiceTask(dto);
        return ResponseEntity.status(HttpStatus.CREATED).body(task);
    }
